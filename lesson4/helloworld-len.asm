; Hellow World Program (Subroutines)
; Compile with: nasm -f elf helloworld-len.asm
; Link with (64 bit systems require elf_i386 option):
;  ld -m elf_i386 helloworld-len.o -o helloworld-lin
...
_start:
  ...
  call	strlen
  ; call out function to calculate the length of the string
...
strlen:
  ...
  push	ebx
  ; push the value in EBX onto the stack to preserve it while we use EBX
  ; in this function
  mov	ebx, eax
  ; move the address in EAX into EBX (Both point to the same segment in
  ; memory)
